...
def scholarship_checker():
    # Guidelines and timelines pull real data thanks to module state integrations
    ...
    if request.method == 'POST':
        try:
            ...
            # STRUCTURAL FALLBACK: Mirrors the backend dictionary payload contract 
            # so Dustin's Jinja template tags render safely without throwing compilation crashes.
            evaluation_result = {
                "is_eligible": False,
